              ...
              Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildLabel('العمر'),
                    _buildInputField(_ageController, 'ادخل عمرك', Icons.cake),
                    const SizedBox(height: 20),

                    _buildLabel('البريد الإلكتروني'),
                    _buildInputField(_emailController, 'ادخل البريد الإلكتروني', Icons.email),
                    const SizedBox(height: 20),

                    _buildLabel('كلمة المرور'),
                    _buildInputField(_passwordController, 'ادخل كلمة المرور', Icons.lock, obscure: true),
                    const SizedBox(height: 30),
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('جاري إنشاء حساب المريض...')),
                            );
                          }
                        },
